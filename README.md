...
## Use of AI tools
This project was built with help of Claude for guidance on architecture decisions specially to make it quick given the time constraint, working with new tech (supabase) was easier because of steps provided by claude, this made initial setup for the DB very fast without wasting much time in goinf thorught docs, code generation, and adjusting the LLM integration.
